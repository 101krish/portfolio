  ...
  const projects = [
    {
      ...
      description:
        "A voice-based mock interview web application designed to help users simulate real-world technical interviews. Built with Next.js and integrated with Vapi for natural, AI-driven voice interactions.",
