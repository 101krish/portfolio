  ...
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "GitHub",
          icon: <Sparkles className="w-4 h-4 text-white" />, // GitHub default
        },
        { name: "Vercel", icon: <SiVercel className="w-4 h-4 text-white" /> },
        { name: "Vapi", icon: <Sparkles className="w-4 h-4 text-white" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "JavaScript",
          icon: <Sparkles className="w-4 h-4 text-[#7C4DFF]" />,
        },
        {
          name: "SQL",
