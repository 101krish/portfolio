  ...
  const educationData = [
    {
      ...
      skills: ["Operating system", "Computer Networdks", "DataBase Management", "OOPs" , "Big Data", "Machine Learning"],
      description:
        "Gained a solid foundation in computing concepts through hands-on labs, industry-oriented coursework, and collaborative projects.",
    },
    {
      ...
      mascot: "📗",
      year: "2021-2022",
      achievements: ["percen. % : 85.6 ", "Field : Science"],
      skills: ["Maths", "Physics ", "Chemistry", "Computer"],
      description:
        "Gained strong foundational knowledge in Mathematics, Physics, and Chemistry, developing a keen analytical mindset and problem-solving approach.",
    },
    {
      degree: "Mother Teresa Mission Higher Secondary School",
      school: "10th (ICSE)",
      mascot: "📗",
      year: "2019-2020",
      achievements: ["percen. % : 90.2 ", "Field : Science"],
      skills: ["Maths", "Physics ", "Chemistry", "Computer"],
      description:
        "Gained strong foundational knowledge in Mathematics, Physics, and Chemistry, developing a keen analytical mindset and problem-solving approach.",
    },
